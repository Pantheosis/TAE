...
def analysis_tables():
    ...
    tables = [
        ...
        ("Dignities and places", "Topical Planets in Houses",
         "Rhetorius Ch. 57 paraphrased, with Firmicus, Mathesis III where Rhetorius is silent; PN IV, Book II paraphrased, the Moon from VII.8 by transit; each half with its locator.",
...
def page_dignities():
    ...
    st.subheader('Topical Planets in Houses', help="Each planet's whole-sign house placement with BOTH readings for that pairing, good and bad, from two sources, printed side by side in each column as Rhetorius: ... and PN IV: ..., each with its locator after the text. The Rhetorius halves are this app's paraphrases of Rhetorius, Astrological Compendium Ch. 57, the significations of the twelve houses, cited by chapter, house and page -- one page, or the pages a reading runs over or folds in (Ch. 57, the sixth, p. 76; the second, pp. 57-61) -- and, where Rhetorius is silent on a planet in a place or says only something general, of Firmicus, Mathesis III.2-III.7 and III.13, the planets in the twelve places, cited by chapter and sentence (III.2, 8) -- one tradition with his, and a half that uses both cites both. The good and bad halves follow each sentence's own valuation: where the only distinction a text makes is sect, the reading sits whole in the half its balance belongs to, prefixed By day, By night, In sect or Out of sect as the text has it, and no half invents a good reading for a planet the texts only condemn in a place -- that half is a dash. The texts' own conditions stay in the cell and long lists are compressed. Where the translators mark a paragraph as printed under the wrong house -- Rhetorius's second set of third-house paragraphs is the ninth's and his second set for Saturn, Jupiter, Mars and Mercury in the eleventh is the fifth's -- it serves the house it belongs to and is cited under it (Ch. 57, the ninth, p. 66), and the other house rests on its own sentences and Firmicus; the Sun and Venus paragraphs printed under the third serve the third as well, as the translator's note there says. Rhetorius's Moon in the sixth, eighth and twelfth is lost in the manuscripts and Firmicus's Moon in the fifth to the eighth is missing, so those halves carry what the chapter's first sentences and the other text give. Fifteen Rhetorius halves are dashes, where neither text has a reading of that valuation. The PN IV halves are this app's paraphrases of Abu Ma'shar's Book II chapters on the lord of the year in the houses of the circle (Saturn II.6, Jupiter II.9, Mars II.12, the Sun II.15, Venus II.18, Mercury II.21), applied to natal planets -- that application is the reading of the TNAC Reference Guide for the Planets and Places (Dykes, 2023), and this app follows it and says so. Each chapter gives, per house or pair of houses, a suitable-condition reading and a not-received, made-unfortunate or retrograde reading; the good/bad split is kept only where the chapter makes it, the text's own conditions (received, retrograde, eastern, if Mars looked at him) stay in the cell, and a paired house cites the pair's sentence. The Moon has no such chapter: II.22, 13 says to judge her in the manner of the rest of the planets, and the translator's note there points to VII.8, her transit through the twelve houses, the only list PN IV has -- so her halves are VII.8, 1-12, each marked By transit; VII.8 makes no good/bad split, so each of her twelve readings sits in the half its balance belongs to and the other half is a dash. Twelve PN IV halves are dashes, all of them the Moon's. The arrangement -- seven planets in twelve places, two sources, good and bad -- is the Guide's; the wording of neither column is.")
    st.caption("Rhetorius Ch. 57 paraphrased, with Firmicus, Mathesis III where Rhetorius is silent; PN IV, Book II paraphrased, the Moon from VII.8 by transit; each half with its locator.")
