...
def analysis_tables():
    ...
    tables = [
        ...
        ("Dignities and places", "Topical Planets in Houses",
         "Rhetorius Ch. 57 and Firmicus, Mathesis III, as the texts state it, under each author's own division; PN IV Book II paraphrased in the two condition columns; the Moon from VII.8 by her transit in her own table; every entry with its locator.",
...
def page_findings():
    ...
    _finding(_gap, "Sahl: indications of fortune and livelihood", "Sahl, On Nativities 2.1-2.21",
              ...
              glance="Sahl's indications of fortune and livelihood. The first row is this app's synthesis: the class it reads from the first and second lords of the sect light's triplicity by whole-sign place, said so, with the partnering lord's modification (2.11, 4) and the Lot of Fortune's step (2.3, 6) beside it; under it the lords, the partnering lord, and every further rule of the chapter that the chart meets, each with Sahl's sentence and the parallel in the Book of Aristotle or Abu 'Ali. Display only; nothing scores it.",
              notes="Sahl, On Nativities 2.1, 2-9: \"And good fortune is based on seven approaches: The first of them, on good fortune and how much that good fortune will come to. Second, <on one who> falls from that good fortune. Third, those whose livelihood is middling. Fourth, the rabble [and] those who come down from an ascent to a downfall. Fifth, those who rise up after wretchedness. Sixth, the wretched who do not cease to be in wretchedness. Seventh, those whose profit comes from their own hands.\" Dykes's comment at the head of the chapter: the fourth repeats the second, and the seventh joins profit from one's own hands with violence and injustice (fn 1; 2.21, 3); his table sets them against the Book of Aristotle's III.2.1-III.2.6.\n\n"
                    "The synthesis. The first two triplicity lords describe the pattern across their periods; the partnering lord, the Lot of Fortune, and other conditions modify the reading. A single seven-class outcome is not specified for every combination in Sahl's chapter, so the first row is this app's synthesis and says \"read by this app as class N\" with its grounds. The pattern is Theophilus's, 2.11, 1-3 -- \"" + PROSPERITY_SAHL['2.11, 1'] + " " + PROSPERITY_SAHL['2.11, 2'] + " " + PROSPERITY_SAHL['2.11, 3'] + "\" -- with 2.11, 5, \"" + PROSPERITY_SAHL['2.11, 5'] + "\", and 2.13, 40, \"" + PROSPERITY_SAHL['2.13, 40'] + "\" Strong is a stake or what follows one, falling the third, sixth, ninth and twelfth (fn 149 on \"strong\"), by whole sign. Both strong is read as class 1 (both in the stakes is 2.3, 2's \"happy for all the days of his life\"); both weak as class 6, the ground naming each lord's weakness -- falling (2.11, 3) or under the rays (2.11, 5) -- since 2.11, 3's word is falling and 2.11, 5 says only that a lord under the rays has no strength; the mixed pair is a timing pattern, \"benefit in the time of the strong one\" (2.11, 2), read by this app as class 2 when the first lord is the strong one and class 5 when the second is, the first lord's time being the beginning of life (2.13, 39). The infortunes with a lord or in its square or opposition are listed: 2.11, 4 makes their aspect an increase or a subtraction, not a class step, and Abu 'Ali's charts read the lords' places.\n\n"
                    "The partnering lord. 2.11, 4: \"" + PROSPERITY_SAHL['2.11, 4'] + "\" -- the third lord of the sect light's triplicity is a stated modifier, ranked third by 2.3, 22 (\"" + PROSPERITY_SAHL['2.3, 22'] + "\"): its row gives its whole-sign place and its effect in Sahl's words, and the synthesis says \"modified by the partnering lord (2.11, 4): supports / brings down\" with no class step, Sahl giving none. A lord under the rays in a stake or what follows one is neither: 2.11, 4's support wants strength and its bringing down a falling place. Abu 'Ali's own phrase for the Lot at Figure 20, \"of the nature of Venus\", is not a rule Sahl states and is not read.\n\n"
                    "Three measures, kept apart. The synthesis reads the whole-sign place from the Ascendant. 2.3, 17-18 -- \"" + PROSPERITY_SAHL['2.3, 17'] + " " + PROSPERITY_SAHL['2.3, 18'] + "\" -- are a second measure, the sign against the degree, read from the quadrant cusps when the chart carries them and shown as their own rows (\"By sign and by degree\"); they move nothing. The fifteen degrees -- \"" + PROSPERITY_SAHL['2.13, 48'] + " " + PROSPERITY_SAHL['2.13, 49'] + " " + PROSPERITY_SAHL['2.13, 50'] + " " + PROSPERITY_SAHL['2.13, 51'] + "\" -- are a third, measured from the axial degree by ascensions (fnn 82-83, 222): oblique ascension from the Ascendant, oblique descension from the seventh, right ascension from the Midheaven and the fourth, the nearest stake behind the lord; shown as the grade row when the chart carries its meridian and latitude, and never folded into strong or weak. No house system is changed by any of the three.\n\n"
                    "The Lot step. 2.3, 6: \"" + PROSPERITY_SAHL['2.3, 6'] + "\" The turn to the Lot is made when either lord is made unfortunate -- not only when both fall -- \"made unfortunate\" being read by this app as a lord weak (falling, or under the rays) or with an infortune with it or in its square or opposition (2.20, 1's gloss, applied here as it is to the Lot, its lord and the lords of places). At the Lot, 2.20, 1-2 say misery, 2.3, 7 and 9 the raise, 2.16, 2 and 4 the middle; where more than one holds, the order 2.20, 1-2, then 2.3, 7 and 9, then 2.16, 2 and 4 is this app's order: Sahl gives an order of investigation (2.3, 6, then 2.3, 10, \"" + PROSPERITY_SAHL['2.3, 10'] + "\"), not a priority among verdicts. Some pairs cannot both hold under the one measure of looking, so no order decides between them: 2.3, 7 (the infortunes not looking at the Lot) against 2.16, 4 (the fortunes and infortunes all looking); 2.3, 7 (the lord cleansed) against 2.16, 2 (the lord made unfortunate); 2.3, 7 (the Lot in a stake or what follows) against 2.20, 1 (the Lot in the sixth or twelfth). The order decides between 2.3, 9 and the rest, and between 2.20 and 2.16. The Lot's verdict is the class only when both lords are weak, the pair then saying baseness throughout; with one lord strong the Lot's verdict stands beside the class with no class step. 2.3, 7's \"eastern or cleansed\" is read as \"and\" (fn 87), and its \"from a strong position\" is not tested. 2.3, 9's \"it occurred in the fifth or eleventh from the Ascendant\" is the Lot's lord, the sentence's subject, and the place tested is the lord's. 2.3, 10-11's further step, the lords of the Ascendant, the Midheaven and the house of hope, is not computed here except as 2.16, 5's motley mixture.\n\n"
                    "2.20, 1, as this app reads its chain: \"" + PROSPERITY_SAHL['2.20, 1'] + "\" The first clause is two alternatives, the lord made unfortunate or the Lot unfortunate; \"it\" in \"the sixth and twelfth\" is the Lot, which is in one of the two places, not both; \"the infortunes were with it or they looked at it from a square or opposition\" says what unfortunate means and is applied to the Lot; \"the lord of the Lot in the house of its fall, or made unfortunate\" is two alternatives; the parenthesis is the sect light; and the Mars clause is for a day birth only -- with the Lot, or opposing or in square to it -- so by night it is not required (fn 256: one manuscript adds \"or with the Sun\"; Carmen has the lord of the Lot). The Lot in the sixth or twelfth with an infortune on it, its lord in its fall or made unfortunate, and Mars on the Lot by day, all together, are what the row tests. 2.20, 2 is read whole, its continuation over the page included: \"" + PROSPERITY_SAHL['2.20, 2'] + "\" -- the lord of the Lot in the sixth or twelfth, Jupiter and Venus both made unfortunate in the sixth or twelfth, both not looking at the Moon; the bracketed \"worse is if\" clause is an aggravation, not a condition, and is not tested (fn 258: added with the sense of Carmen).\n\n"
...
def page_dignities():
    ...
    # the tick grids do: a selection reruns this block alone and prints
    # every entry of the planet's Rhetorius/Firmicus list in full under
    # the table, the entries a long cell left to the detail included.
    @st.fragment
    def _planets_in_houses_block():
        ...
        if _picked and 0 <= _picked[0] < len(planets_in_houses_data):
            _row = planets_in_houses_data[_picked[0]]
            st.subheader(f"{_row['Planet']} in the {HOUSE_ORDINAL[_row['Placed in (WS place)']]} place: "
                         f"{len(_row['Entries'])} {'entry' if len(_row['Entries']) == 1 else 'entries'}")
            for _entry in _row['Entries']:
                st.markdown(_entry)
